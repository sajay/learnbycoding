...
# we would just sort the array, while filtering out negative numbers, and iterate over the sorted array 
# and return the first number that doesn't match the index. 
...
# of the array. We don't care about the others. 
# This only takes O(N) time, since we swap each element at most once.
