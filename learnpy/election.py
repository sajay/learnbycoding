#Write a script election.py that will simulate an election between two candidates, A and B.#One of the candidates wins the overall election by a #majority based on the outcomes of
#three regional elections. (In other words, a candidate wins the overall election by winning
#at least two regional elections.) Candidate A has the following odds:
